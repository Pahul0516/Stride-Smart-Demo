...
async function init() {
    ...
    document.getElementById('temperature-button').addEventListener('click', () => {
        toggleOverlay("/static/data/filtered_cluj_polygons.geojson", "comfort");

    });

    document.getElementById('air-quality-button').addEventListener('click', () =>
        toggleOverlay("/static/data/air_quality.geojson", "air_quality")
    )

    document.getElementById('green-button').addEventListener('click', () => {
        toggleOverlay("/static/data/filtered_cluj_polygons.geojson", "green")
    })

    document.getElementById('accessibility-button').addEventListener('click', () => {
        toggleOverlay("/static/data/zone_accesibile_reprojected.geojson", "accessibility")
        toggleOverlay("/static/data/zone_neaccesibile_reprojected.geojson", "inaccessibility");
    })

    document.getElementById('safety-button').addEventListener('click', () =>
        toggleOverlay("/static/data/road_crash_density.geojson", "safety")
    )
